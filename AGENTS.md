...
## Screenshot Workflow
- Puppeteer is installed locally via npm in the project root (`node_modules/puppeteer`).
...
- `/site-revamp [url]` — Full website redesign from an existing client site. Extracts all content & brand assets, proposes 2-3 visual directions, then builds a complete multi-page static site (HTML + Tailwind + GSAP). Uses `/frontend-design` internally.
